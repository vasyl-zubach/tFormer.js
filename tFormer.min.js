...
b.xhrTimeout&&clearTimeout(b.xhrTimeout);b.hold(!1);0<c&&!0!==a.no_timeout?b.xhrTimeout=setTimeout(function(){m()},c):m()};j.execute=function(a,b){if(!this.silence)return"string"==typeof a&&(a=this.get(a)),this.parent.execute(this.el,a,b)};var t=function(a,b){var c=this.attr("type");this.parent=a;this.el=b;this.config={};this.events=[];this.name=c="submit"===c?c:this.data("check");this.set(w(k(a.config),k(a.config.buttons?a.config.buttons[c]:{})));return this.init()};h(t,f);f=t.prototype;f.init=function(){var a=
this,b=a.el,c=a.parent;a.inited&&a.destroy();if("submit"==b.type||b==c.get("submitButton"))a.on("click",function(a){a.preventDefault();c.form.onsubmit(a);return!1});else a.on("click",function(){var b=c.field(a.data("check"));b&&b.validate({no_timeout:!0})});this.inited=!0;return this};f.disable=function(){this.addClass(this.get("disabledClass"));return this};f.enable=function(){this.removeClass(this.get("disabledClass"));return this};var w=function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c]);
return a},k=function(a){return"[object Array]"==Object.prototype.toString.call(a)?a.slice():w({},a)},l=function(a,b){for(var c=-1,d=a?a.length:0;++c<d;)if(a[c]===b)return c;return-1},u=function(a,b,c){switch(c){case null:a&&a.removeAttribute("data-"+b);break;case p:return!a?null:a.getAttribute("data-"+b);default:s(a,"data-"+b,c)}},s=function(a,b,c){if(!a)return null;a.setAttribute(b,c)},n={_factories:[function(){return new XMLHttpRequest},function(){return new ActiveXObject("Msxml2.XMLHTTP")},function(){return new ActiveXObject("Microsoft.XMLHTTP")}],
_factory:null,newRequest:function(){if(null!==n._factory)return n._factory();for(var a=0;a<n._factories.length;a++)try{var b=n._factories[a],c=b();if(null!==c)return n._factory=b,c}catch(d){}n._factory=function(){throw Error("Object XMLHttpRequest not supported");};n._factory()}},E=function(a){var b=[],c=/%20/g,d;for(d in a){var e=encodeURIComponent(d).replace(c,"+")+"=",e=e+encodeURIComponent(a[d].toString()).replace(c,"+");b.push(e)}return b.join("&")}})(window,document);
